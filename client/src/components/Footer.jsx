        ...
        <div className=''>
          ...
          <div className='container mx-auto px-5 pt-6 pb-8 flex flex-wrap items-center justify-between '>
            ...
            <span className='inline-flex lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto'>
              <a className='text-white text-xl hover:cursor-pointer  hover:scale-125 ease-in-out duration-300' href='https://www.facebook.com/foysal7788'>
                <FaFacebookF />
              </a>
              <a  className='ml-3 hover:cursor-pointer text-white text-xl  hover:scale-125 ease-in-out duration-300' href='https://www.facebook.com/foysal7788'>
                <FaTwitter />
              </a>
              <a className='ml-3 hover:cursor-pointer text-white text-xl  hover:scale-125 ease-in-out duration-300' href='https://www.facebook.com/foysal7788'>
                <FiInstagram />
