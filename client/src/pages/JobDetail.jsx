...
const JobDetail = () => {
  ...
  const handleApply = async () => {
    alert("Comming Soon This Function Is In Under Development")
  }
      ...
      <div className='w-full flex flex-col md:flex-row gap-10'>
       ...
       <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md'>
        ...
        {  user?._id === job?.company._id ?
          ...
          containerStyles={`w-full flex items-center text-white justify-center text-white bg-red-700 py-3 px-5 outline-none rounded-full text-base`}
        />  ) : (
          <CustomButton
          onClick={handleApply}
            title='Apply Now'
